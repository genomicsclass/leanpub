...
![Histogram of median expresion y-axis. We can see females and males.](images/R/eda_with_pca-predict_sex-1.png) 
...
![Image of correlations. Cell i,j  represents correlation between samples i and j. Red is high, white is 0 and red is negative.](images/R/eda_with_pca-correlations-1.png) 
...
![Variance explained plot for simulated independent data.](images/R/eda_with_pca-null_variance_explained-1.png) 
...
![Variance explained plot for gene expression data.](images/R/eda_with_pca-variance_explained-1.png) 
...
![First two PCs for gene expression data with color representing ethnicity.](images/R/eda_with_pca-mds_plot-1.png) 
...
![First two PCs for gene expression data with color representing processing year.](images/R/eda_with_pca-mds_plot2-1.png) 
...
![Boxplot of first four PCs stratified by month](images/R/eda_with_pca-pc_boxplots-1.png) 
...
![Adjusted R-squared after fitting a model with each month as a factor to each PC.](images/R/eda_with_pca-month_PC_corr-1.png) 
...
![Square root of F-statistics  from an analysis of variance to explain PCs with month.](images/R/eda_with_pca-fstat_month_PC-1.png) 
