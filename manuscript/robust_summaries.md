...
![Scatter plot showing bivariate normal data with one signle outlier resulting in large values in both dimensions.](images/R/robust_summaries-scatter_plot_showing_outlier-1.png) 
...
![Scatter plot of original data (left) and ranks (right). Spearman correlation reduces the influence of outliers by considering the ranks instaed of original data.](images/R/robust_summaries-spearman_corr_illustration-1.png) 
